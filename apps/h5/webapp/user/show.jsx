  ...
  initState(props) {
    this.state = {
      user: {
        ...
        videoCount: 0,
        videos: [],
        backgroundImage: TS.IMG_ROOT + 'user/default_bg.png',
        'is_me': true,
        'followStatus': false,
      },
      Snackbar: {
        ...
        <div style={styles.root}>
          ...
          <div
            style={{
              ...
              textAlign: 'center',
              paddingTop: 70,
              backgroundImage: 'url(' + this.state.user.backgroundImage + ')',
          ...
          >
            ...
            <div style={styles.username}>
              ...
              {this.state.user.sex == 2
                ? (<img style={styles.usernameSex} src={TS.IMG_ROOT + 'user/ic_woman.png'} />)
                : (<img style={styles.usernameSex} src={TS.IMG_ROOT + 'user/ic_man.png'} />)
              }
