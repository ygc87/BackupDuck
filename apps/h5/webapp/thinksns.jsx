...
/* 离线缓存更新 */ // 用户下次进入的时候展示更新内容
// 浏览器会缓存当前页面，后面再考虑是否进来只加载框架，不加载初始内容，然后执行默认pajx时间拉取内容
window.applicationCache && window.applicationCache.addEventListener('updateready', function(event){
